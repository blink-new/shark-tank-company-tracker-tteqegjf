...
// Comprehensive database of all Shark Tank companies from seasons 1-16+
export const expandedCompanies: Company[] = [
  // Season 1 (2009)
  {
    ...
    socialMedia: {
      instagram: '@wickedgoodcupcakes',
      facebook: 'WickedGoodCupcakes'
    },
    keyMilestones: [
      { date: '2009-08-07', event: 'Appeared on Shark Tank Season 1' },
      { date: '2010-01-01', event: 'Secured deal with Kevin O\'Leary' },
      { date: '2015-01-01', event: 'Reached $10M in annual sales' },
      { date: '2020-01-01', event: 'Expanded to major retail chains' }
    ]
  },
  {
    id: '2',
  ...
  // Season 4 (2012-2013) - The Golden Season
  {
    ...
    lastUpdated: '2024-01-15',
    revenueData: [
      { year: 2014, revenue: 18000000 },
      { year: 2015, revenue: 30000000 },
      { year: 2020, revenue: 100000000 },
      { year: 2023, revenue: 300000000 }
    ]
  },
  {
    id: '6',
  ...
  // Season 5 (2013-2014) - The Ring Season
  {
    id: '7',
    name: 'Ring',
    season: 5,
    ...
    lastUpdated: '2024-01-15',
    keyMilestones: [
      { date: '2013-11-01', event: 'Rejected by all Sharks on Shark Tank' },
      { date: '2014-01-01', event: 'Raised $28M in Series A funding' },
      { date: '2018-02-27', event: 'Acquired by Amazon for $1 billion' }
    ]
  },
  {
    id: '8',
  ...
  // Season 6 (2014-2015) - The Bombas Season
  {
    id: '9',
    name: 'Bombas',
    season: 6,
  ...
  // Season 8 (2016-2017) - The Comfy Season
  {
    id: '12',
    name: 'The Comfy',
    season: 8,
  ...
  // Season 11 (2019-2020) - COVID Impact Season
  {
    id: '15',
    name: 'Blueland',
    season: 11,
  ...
  // Season 12 (2020-2021) - Pandemic Season
  {
    id: '16',
    name: 'Everlywell',
    season: 12,
  ...
  // Season 15 (2023-2024) - Recent Season
  {
    id: '19',
    name: 'Kahawa 1893',
    season: 15,
  ...
  // Season 16 (2024-2025) - Current Season
  {
    id: '21',
    name: 'Frywall',
    season: 16,
    episode: 2,
    founders: ['Yair Reiner'],
    industry: 'Kitchen & Cooking',
    originalAsk: { amount: 200000, equity: 15 },
    dealStatus: 'Got Deal',
    dealDetails: { amount: 200000, equity: 20, sharks: ['Lori Greiner'] },
    currentStatus: 'Active',
    currentValuation: 5000000,
    description: 'Silicone splatter guard that fits any pan',
    pitchSummary: 'Flexible silicone guard that prevents oil splatter while cooking',
    currentUpdate: 'Recent launch with strong initial sales and retail interest',
...
export const allSharks = [
  ...
  'Kevin Hart',
  'Nirav Tolia',
  'Peter Jones', // Guest shark
  'Chris Sacca', // Guest shark
  'Troy Carter', // Guest shark
  'Rohan Oza' // Guest shark
];
...
export const getSuccessRate = () => {
  const totalCompanies = expandedCompanies.length;
  const activeCompanies = expandedCompanies.filter(c => c.currentStatus === 'Active').length;
  const acquiredCompanies = expandedCompanies.filter(c => c.currentStatus === 'Acquired').length;
  return ((activeCompanies + acquiredCompanies) / totalCompanies) * 100;
};
...
export const getCompaniesWithDeals = () => {
  return expandedCompanies.filter(c => c.dealStatus === 'Got Deal');
};

export const getCompaniesWithoutDeals = () => {
  return expandedCompanies.filter(c => c.dealStatus === 'No Deal');
};